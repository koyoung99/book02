...
public class BookApp {
	...
	public static void main(String[] args) {
		...
		/*
		 * for(int i=0; i<authorList.size(); i++) { AuthorVo authorVo =
		 * authorList.get(i);
		 * 
		 * int id = authorVo.getAuthorId(); String name = authorVo.getAuthorName();
		 * String desc = authorVo.getAuthorDesc(); System.out.println(id + ",    " +
		 * name + ",    " + desc); }
		 */
		 ...
		 * 
		 * 
		 * authorDao.authorInsert("이문열", "경북영양"); authorDao.authorInsert("박경리", "토지작가");
		 * 
		 * authorDao.authorDelete(2); authorDao.authorUpdate(1, "기안84", "웹툰작가");
